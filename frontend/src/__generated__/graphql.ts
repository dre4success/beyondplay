...
export type CountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, capital?: string | null, emoji: string, phones: Array<string>, languages: Array<{ __typename?: 'Language', code: string, name: string }> }> };

export type AllFimsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllFimsQuery = { __typename?: 'Query', allFilms?: { __typename?: 'FilmsConnection', films?: Array<{ __typename?: 'Film', director?: string | null, releaseDate?: string | null, title?: string | null } | null> | null } | null };
